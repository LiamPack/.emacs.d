...
** Fonts
   ...
   (setq lp/default-font "iosevka term light")

   (setq lp/default-font-size 24)
...
**** ibuffer-vc
     ...
     I don't even know what this does tbh but let's do it
     #+BEGIN_SRC emacs-lisp
...
** Base Org
  ...
  last month with the Category Foo."
    ...
    (add-hook 'org-finalize-agenda-hook 'nox/org-agenda-finalize)
...
*** recentf
    ...
    #+END_SRC
*** ztree
    cute tree navigation of file systems. Dangerous to change
    something into ztree mode.. Don't do it
    #+BEGIN_SRC emacs-lisp
      (use-package ztree
        :ensure t)
    #+END_SRC
