...
** Fonts
   ...
   vanilla emacs afaik.
   #+BEGIN_SRC emacs-lisp
   ;; iosevka term light, consolas, source code pro, Fira Code light, dejavu, IBM 3270,
   ;; Fantasque Sans Mono, Terminus
   (setq lp/default-font "fira code light")
...
=======
     ...
     (moe-dark))
>>>>>>> e8ab69e917559a62fb6b0d7527b7879132fd022a
