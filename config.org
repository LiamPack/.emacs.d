...
** zenburn, a soft low-contrast dark-ish theme
#+begin_src emacs-lisp
(lp-emacs-elpa-package 'zenburn-theme)
#+end_src
** Anti-Bright theme, a soft low-contrast light theme
#+begin_src emacs-lisp
...
(lp-emacs-elpa-package 'paredit
  (defun activate-paredit ()
    (interactive)
    (paredit-mode +1))
  (add-hook 'emacs-lisp-mode-hook #'activate-paredit)
  (add-hook 'lisp-mode-hook #'activate-paredit)
  (add-hook 'scheme-mode-hook #'activate-paredit)  
  (add-hook 'geiser-mode-hook #'activate-paredit)  
  (add-hook 'geiser-mode-hook #'activate-paredit))
