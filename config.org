...
"
  ...
  (define-key (kbd "C-<tab>") 'next-window-any-frame)
  (define-key (kbd "<backtab>") 'previous-window-any-frame)
  (define-key (kbd "C-c w") 'enlarge-window-horizontally)
  (define-key (kbd "C-x C-M-e") 'pp-macroexpand-last-sexp)
  (define-key (kbd "C-x C-e") 'eval-defun)
  (define-key (kbd "C-x e") 'eval-last-sexp)
  (define-key (kbd "C-h j") 'describe-keymap)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  ;; with C-c q
  (global-set-key org-mode-map (kbd "C-c q") 'auto-fill-mode)
...
(use-package consult-bibtex
  ...
  :config
  (define-key consult-search-map (kbd "b") #'consult-bibtex)
