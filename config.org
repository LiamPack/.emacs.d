...
incessantly yak-shaving since I had no laws about which packages to install, so keeping a
simple-,-preferred-built-in approach forces me to think twice about whether I really need
...
** zenburn, a soft low-contrast theme
#+begin_src emacs-lisp
