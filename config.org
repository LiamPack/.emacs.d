...
(set-face-attribute 'default nil :font "Iosevka Comfy fixed" :height 140)
...
#+RESULTS:
| flymake-racket-add-hook | paredit-mode | geiser-mode--maybe-activate |
...
#+RESULTS:
: ((KAWA_HOME) (JAVA_HOME . /usr/lib/jvm/java-1.11.0-openjdk-amd64/) (PATH . /home/liamp/.cargo/bin:/home/liamp/.opam/4.13.0/bin:/home/liamp/julia-1.6.5/bin:/home/liamp/.local/bin:/home/liamp/bin:/home/liamp/.local/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/snap/bin:/snap/bin/))
...
** moldable-emacs, code-compass, etc
#+begin_src emacs-lisp
