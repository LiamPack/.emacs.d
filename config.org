...
** USLS
#+begin_src emacs-lisp
(when (not (directory-name-p "~/.emacs.d/elpa/usls"))
...
In the
#+begin_src emacs-lisp
(when (not (directory-name-p "~/.emacs.d/elpa/moldable-emacs"))
  (shell-command "cd ~/.emacs.d/elpa && git clone git@github.com:ag91/moldable-emacs.git"))
(add-to-list 'load-path "~/.emacs.d/elpa/moldable-emacs")
