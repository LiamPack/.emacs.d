...
(use-package mct
  ...
  (define-key mct-minibuffer-local-completion-map (kbd "<return>")
    #'(lambda () (interactive)
        (minibuffer-force-complete)
        (minibuffer-complete-and-exit)))
  (define-key mct-minibuffer-local-completion-map (kbd "M-<return>") #'minibuffer-complete-and-exit)
...
(use-package eglot
  :diminish lsp-mode
  :straight t
  :hook (((python-mode-hook cc-mode-hook c-mode-hook c++-mode-hook cuda-mode-hook c-common-mode-hook julia-mode-hook rjsx-mode-hook typescript-mode-hook tuarget-mode-hook ) . eglot-ensure)
         )
  :config
...
(use-package meow
  ...
  (setf meow-mode-state-list (append meow-mode-state-list
                                     '((magit . motion)
                                       (dired . motion))))
